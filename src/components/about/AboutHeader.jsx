...
const AboutHeader = () => {
  ...
  // i18n content
  const title = t("aboutPage.header.title");
  const subtitle = t("aboutPage.header.subtitle");
  const altText = t("aboutPage.header.alt");
  ...
  return (
    ...
    >
      ...
      {/* Enhanced Styles – NOTE: plain <style>, not style jsx */}
      <style>{`
