...
const DEFAULT_COLOR = "#A2811F"; // brand gold
...
const LightRays = ({
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      // Tiny delay so container has final size
  ...
  return (
    <div
      ...
      className={[
        ...
        // prefers-reduced-motion support via Tailwind
        "motion-safe:opacity-90 motion-reduce:hidden",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
